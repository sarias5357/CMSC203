...
public class TwoDimArrayPractice extends JFrame
{
    ...
    // Write your code here:
	   for (int row = 0; row < intArray.length; row++) {
		   for (int column = 0; column < intArray[0].length; column++) {
			   System.out.print(intArray[row][column] + " "); // Print value with a space after
			   animate(row, column);
		   }
   ...
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
	   for (int i = row; i < row + 1; i++) {
		   for (int column = 0; column < intArray[row].length; column++) {
			   // Set every column in specified row to a value
   ...
   *  @return min  the minimum value found in the column
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   int min = intArray[0][column]; // Set minimum to the first value in the column
	   for (int i = column; i < column + 1; i++) {
		// Iterate through each element in the column and check if it is less than the minimum.
		 // If so, set that element as the minimum value
		   for (int row = 0; row < intArray.length; row++) {
   ...
   *  @return  count the number of times value was found
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   ...
	   for (int row = 0; row < intArray.length; row++) {
		   // Go through each element and increment count if the value is found
		   for (int column = 0; column < intArray[row].length; column++) {
